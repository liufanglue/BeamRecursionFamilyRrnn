...
class RecurrentRnnNetWork_config(HEBT_GRC_config):
    def __init__(self):
        super().__init__()
        self.encoder_type = "RecurrentRnnNetWork"
        self.model_name = "(RecurrentRnnNetWork)"
        ...
        self.maxLevelNum = 6
        self.manualSeed = 42
        self.resDropRate = 0.02
        self.batchSize = self.batch_size
        self.learnRate = 1e-3
        self.weightDecay = 1e-7
